...
const ProductList = ({ productSearchValue }) => {
  ...
  return (
    <div>
      ...
      <button className="btn btn-primary" onClick={reloadProducts}>
        {selectedLanguage==="FR"? "Recharger les produits" : "Reload products"} 
      </button>
      <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
        {products.map(
          (product) =>
            product.title.includes(productSearchValue) && (
                ...
                >
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      <strong>
                        {selectedLanguage === "FR" ? "Prix" : "Price"}{" "}
                      </strong>
                      {product.price}
                      {selectedLanguage === "FR" ? "€" : "$"}
                    </p>
